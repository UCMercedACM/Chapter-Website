(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
            var WorkshopCardComponent = /** @class */ (function () {
                function WorkshopCardComponent() {
                }
                WorkshopCardComponent.prototype.ngOnInit = function () { };
                return WorkshopCardComponent;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
            var CoffeeNCodeComponent = /** @class */ (function () {
                function CoffeeNCodeComponent() {
                }
                CoffeeNCodeComponent.prototype.ngOnInit = function () { };
                return CoffeeNCodeComponent;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
            var LanComponent = /** @class */ (function () {
                function LanComponent() {
                }
                LanComponent.prototype.ngOnInit = function () { };
                return LanComponent;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var MembersComponent = /** @class */ (function () {
                function MembersComponent(store$) {
                    var _this = this;
                    this.store$ = store$;
                    this.store$
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var loadMembers = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createAction"])("[Member] Load Members");
            var loadMembersSuccess = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createAction"])("[Member] Load Members Success", Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["props"])());
            var loadMembersFailure = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createAction"])("[Member] Load Members Failure", function (error) {
                if (error === void 0) { error = "Error loading members"; }
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var MemberStoreEffects = /** @class */ (function () {
                function MemberStoreEffects(dataService, actions) {
                    var _this = this;
                    this.dataService = dataService;
                    this.actions = actions;
                    this.loadMemberStores$ = Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["createEffect"])(function () {
                        return _this.actions.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["ofType"])(_actions__WEBPACK_IMPORTED_MODULE_6__["loadMembers"]), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["concatMap"])(function () { return _this.dataService.getMembers().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (data) { return _actions__WEBPACK_IMPORTED_MODULE_6__["loadMembersSuccess"]({ data: data }); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (error) { return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["of"])(_actions__WEBPACK_IMPORTED_MODULE_6__["loadMembersFailure"]({ error: error })); })); }));
                    });
                }
                return MemberStoreEffects;
            }());
            MemberStoreEffects.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var memberReducer = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createReducer"])(_state__WEBPACK_IMPORTED_MODULE_2__["initialState"], Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["on"])(_actions__WEBPACK_IMPORTED_MODULE_3__["loadMembers"], function (state) {
                return Object.assign({}, state, { isLoading: true, error: null });
            }), Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["on"])(_actions__WEBPACK_IMPORTED_MODULE_3__["loadMembersSuccess"], function (state, action) {
            ...
            }), Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["on"])(_actions__WEBPACK_IMPORTED_MODULE_3__["loadMembersFailure"], function (state, action) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var selectMemberState = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createFeatureSelector"])("member");
            var getSelectedMemberId = function (state) { return state.selectedMemberId; };
            // get the selectors
            var _a = _state__WEBPACK_IMPORTED_MODULE_2__["memberAdapter"].getSelectors(), selectIds = _a.selectIds, selectEntities = _a.selectEntities, selectAll = _a.selectAll, selectTotal = _a.selectTotal;
            var getMembers = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createSelector"])(selectMemberState, function (props) { return props; });
            // select the array of member ids
            var selectMemberIds = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createSelector"])(selectMemberState, selectIds // shorthand for MemberState => fromUser.selectMemberIds(MemberState)
            );
            // select the dictionary of member entities
            var selectMemberEntities = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createSelector"])(selectMemberState, selectEntities);
            // select the array of members
            var selectAllMembers = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createSelector"])(selectMemberState, selectAll);
            // select the total member count
            var selectMemberTotal = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createSelector"])(selectMemberState, selectTotal);
            var selectCurrentMemberId = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createSelector"])(selectMemberState, getSelectedMemberId);
            var selectCurrentMember = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createSelector"])(selectMemberEntities, selectCurrentMemberId, function (memberEntities, memberId) { return memberEntities[memberId]; });
            var selectAllMemberItems = _state__WEBPACK_IMPORTED_MODULE_2__["memberAdapter"].getSelectors(selectMemberState).selectAll;
            var selectMemberById = function (id) { return Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createSelector"])(undefined.selectAllMemberItems, function (allMembers) {
                if (allMembers) {
                    return allMembers.find(function (p) { return p.id === id; });
                }
                else {
                    return null;
                }
            ...
            var selectMemberIsLoading = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createSelector"])(selectMemberState, getIsLoading);
            var getError = function (state) { return state.error; };
            var selectMemberError = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createSelector"])(selectMemberState, getError);
            /***/ 
        }),
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var memberAdapter = Object(_ngrx_entity__WEBPACK_IMPORTED_MODULE_1__["createEntityAdapter"])({
                selectId: selectedMemberId,
                sortComparer: sortByEmail
            });
            var initialState = memberAdapter.getInitialState({
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var selectError = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createSelector"])(_member__WEBPACK_IMPORTED_MODULE_2__["MemberStoreSelectors"].selectMemberError, function (memberError) {
                return memberError;
            });
            var selectIsLoading = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createSelector"])(_member__WEBPACK_IMPORTED_MODULE_2__["MemberStoreSelectors"].selectMemberIsLoading, function (member) {
                return member;
            });
            /***/ 
        }),
            ...
            var DataService = /** @class */ (function () {
                ...
                DataService.prototype.getMembers = function () {
                    return this.http
                        ...
                        .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (result) { return result.members; }));
                };
                return DataService;
            }());
