import {
  ...
  export const selectWorkshopState = createFeatureSelector<WorkshopState>("workshop");
  ...
  export const getIsLoading = (state: WorkshopState): boolean => state.isLoading;
  export const selectWorkshopIsLoading = createSelector(selectWorkshopState, getIsLoading);
  
  export const getError = (state: WorkshopState): any => state.error;
  export const selectWorkshopError = createSelector(selectWorkshopState, getError);
